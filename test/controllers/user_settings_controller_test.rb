...
class UserSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_setting" do
    assert_difference("UserSetting.count") do
      post user_settings_url, params: { user_setting: { first_name: @user_setting.first_name, last_name: @user_setting.last_name } }
    end
  ...
  test "should update user_setting" do
    patch user_setting_url(@user_setting), params: { user_setting: { first_name: @user_setting.first_name, last_name: @user_setting.last_name } }
